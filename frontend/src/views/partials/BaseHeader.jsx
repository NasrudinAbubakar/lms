...
function BaseHeader() {
    ...
    // Helper: is the user a teacher?
    const isTeacher = !!user?.teacher_id && user.teacher_id !== 0;
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <ul className="dropdown-menu">
                                    {isTeacher ? (
                                        ...
                                        <li>
                                            <Link className="dropdown-item" to="/become-teacher">
                                                <i className="fas fa-chalkboard-teacher"></i> Teach Now
                                            </Link>
                                        </li>
                                    )}
                                </ul>
